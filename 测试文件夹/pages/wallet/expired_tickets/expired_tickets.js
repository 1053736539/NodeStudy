// pages/wallet/expired_tickets/expired_tickets.js
...
Page({
  ...
  // 请求清空失效券
  fetchCleanExpiredTickets: function () {
    var dataBody = {};
    dataBody.type = '2';
    dataBody.userId = this.data.userInfo.user.id;
    dataBody.accessToken = this.data.userInfo.user.accesstoken;
  ...
  // 点击清空失效券
  didTapCleanExpiredTickets: function () {
    var that = this;
    wx.showModal({
      title: '确认要清空失效券吗？',
      confirmText: '是的',
